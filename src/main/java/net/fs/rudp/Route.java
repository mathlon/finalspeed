...
public class Route {
    ...
    HashMap<Integer, ConnectionUDP> connTable;

    public static ThreadPoolExecutor es;

    AckListManage delayAckManage;

    private final Object syn_ds2Table = new Object();

    private Random ran;

    int localclientId = Math.abs(0);
    ...
    int mode = mode_client;//1客户端,2服务端
    ...
    ConnectionProcessor createTunnelProcessor() {
